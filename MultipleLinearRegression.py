...
clss = linear_model.LinearRegression()
...
scores = cross_val_score(clss, X_train, y_train, scoring='neg_mean_squared_error', cv=5)
modelscore = abs(scores.mean())
print("cross validation score is "+ str(modelscore))
...
print(' Rigde Regularization test  Mean Square Error ', metrics.mean_squared_error(y_test, y_pred))


print("Intercept: ",clss.intercept_)
print("coefficient of X:",clss.coef_)
